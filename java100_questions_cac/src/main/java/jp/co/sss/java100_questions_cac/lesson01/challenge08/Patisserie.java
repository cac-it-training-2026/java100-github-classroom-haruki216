...
public class Patisserie {
	public static void main(String[] args) throws IOException {
		...
		System.out.println(
				"シトロン　　　" + "\\" + (int) (250 * citronBuyCount) + "・・・"
						+ (int) ((citronBuyCount * 250) / totalPrice * 100)
						+ "%");
		System.out.println(
				"ショコラ　　　" + "\\" + (int) (280 * chocolatBuyCount) + "・・・"
						+ (int) ((chocolatBuyCount * 280) / totalPrice * 100) + "%");
		System.out.println("ピスターシュ　" + "\\" + (int) (320 * pistacheBuyCount) + "・・・"
				+ (int) ((pistacheBuyCount * 320) / totalPrice * 100) + "%");
	}
}
